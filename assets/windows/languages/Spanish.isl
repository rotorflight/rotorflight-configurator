...
ExistingFileReadOnly2=El archivo existente no puede ser reemplazado debido a que est� marcado como s�lo-lectura.
ExistingFileReadOnlyRetry=&Elimine el atributo de s�lo-lectura y reintente
...
STDFUDriverTaskDesc=Instalar el controlador STM32 DFU (requerido para el flasheo de firmware)