// Ported from C:\GitHub\wingflight-lua-ethos-suite\src\wfsuite\tasks\scheduler\msp\api\ESC_PARAMETERS_ZTW.lua
// and escmfg/ztw/{init.lua,pages/*.lua}. Group B (native MSP, no target-switch handshake).
//
